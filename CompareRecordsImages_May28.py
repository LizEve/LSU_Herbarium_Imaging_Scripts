...
def compareFiles(oldPathDictionary,portalDictionary):
    ...
    # barcode:portal
    barcodeNoImageDict={}
    imageOut = open("barcodeImageDict.txt",'w')
    noimageOut = open("barcodeNoImageDict.txt",'w')
    ...
    for bcp in portalDictionary:
        ...
        if bcp in oldDictionary_BCcaps:
            barcodeImageDict[bcp]=portalDictionary[bcp]
...
rootNO = '/data_storage/nfsshare/no/vas_plants/'
