...
suffix1=_serverWS1.txt # adding "_server" to end of log file so it is differentiated from log files sorted locally
csvfolder1=/mnt/LSUCollectionsWS1/UnmappedCSV/
...
csvfolder2=/mnt/LSUCollections/UnmappedCSV/
