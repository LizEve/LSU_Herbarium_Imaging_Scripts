...
def badBarcodeSequence(p,b,barcode_Dict,unwanted,badBarcodePath,badbarcode_dict):
    ...
    for p in barcode_Dict[b]:
        ...
        if any(x in p for x in unwanted):
            ...
            # Try and get creation date of file 
            try:
                d = creation_date(p)
            ...
            # Try to move file 
            try:
                print(newPath+", badbarcode moved")
...
def main():
    ...
    # barcode: portal
    barcode_pkl='/mnt/c/Users/image/Documents/MovingFiles_GGM/ws1_imageFiles_Oct02_barcode.pkl'
    portal_pkl='/mnt/c/Users/image/Documents/MovingFiles_GGM/masterDF_july24.pkl'
    new_root='/mnt/e/CFLA-LSU-Station1/LSUCollections/'
    outFolder='/mnt/c/Users/image/Documents/MovingFiles_GGM'
    noPortalPath='/mnt/e/CFLA-LSU-Station1/LSUCollections/NoPortal/LSU/'
    badBarcodePath='/mnt/e/CFLA-LSU-Station1/LSUCollections/BadBarcode/LSU/'
    dPath='/mnt/e/CFLA-LSU-Station1/LSUCollections/Duplicates/LSU/'
    barcodeLen=11
    ...
    newPaths,badbarcode,duplicate=moveFiles(new_root,barcode_dict,portal_dict,unwanted,noPortalPath,badBarcodePath,barcodeLen,dPath)
    pklDictOut(newPaths,outFolder,'ws1_newPaths_Oct07')
    pklDictOut(badbarcode,outFolder,'ws1_badBarcode_Oct07')
    pklDictOut(duplicate,outFolder,'ws1_duplicate_Oct07')
