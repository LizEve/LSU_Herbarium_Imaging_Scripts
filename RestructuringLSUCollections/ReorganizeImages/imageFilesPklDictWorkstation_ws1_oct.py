...
def main():
    ...
    unwanted=["txt","tmp","csv","zip","_s","_m","_l","_S","_M","_L","js","as","tlog","py","html","md"]
    ...
    # need to figure out which folders on workstation to backup 
    root2 = '/mnt/e/CFLA-LSU-Station1'

    # Get dictionaries of files and barcodes 
    d1,d2=pathDict([root2],unwanted)
    # Save dictionaries to pkl files
    pklDictOut(d1,outFolder,'ws1_cleanedFiles_Oct10_filename')
    pklDictOut(d2,outFolder,'ws1_cleanedFiles_Oct10_barcode')
